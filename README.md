...
Lcd_PortType ports[] = {GPIOA,GPIOA,GPIOA,GPIOA};
  ...
  Lcd_cursor(&lcd, 1,0);
  Lcd_string(&lcd, "Jayadeep");

```
## Output screen shots of proteus  :
 ![Screenshot 2024-09-25 204656](https://github.com/user-attachments/assets/3300ee47-10a1-4bf9-8826-6b38830f2d7b)

 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 ![image](https://github.com/user-attachments/assets/ad6e808c-0988-493f-9397-d7c16e52fb33)
